...
export class SourceSignatureExtractor {
    ...
    public async getSignature(
        ...
        const sourcePaths = (library as any).sourcePaths as Record<string, string> | undefined;
        ...
        const meta = library.metadata as any;
        ...
        for (const line of lines) {
            ...
            if (capturing) {
                ...
                if (capturedLines.length > 100) break;
            }
        }
